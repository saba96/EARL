{
    ...
    train_paths_file: [
        "earl-datasets/omniedit/train/list/tokenized_datalist.json",
    ...
    // simple-only omniedit has 100K sameple in this setup; to balance representation
    // each complex dataset should've 50K sample approx, so we upscale or downscale
    coefficients: [
        0.13
        6
        6
    ...
    model_path: "mair-lab/thinking-sft-simple",
